...
$TimeSub120 = (Get-Date -DisplayHint Time).AddMinutes(-120)
...
$CSVFile | Select -Skip 5 | Where {$_.Date -EQ $Date -and $_.Time -GE $TimeSub120.ToString("HH:mm:ss") -and $_.SourceIP -NE '127.0.0.1' -and $_.DestPort -EQ '3389'} | Group-Object -Property SourceIP -NoElement | Where {$_.Count -GT '10'} | Sort-Object -Descending | % {
